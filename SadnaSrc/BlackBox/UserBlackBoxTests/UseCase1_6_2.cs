...
namespace BlackBox.UserBlackBoxTests
{
	...
	public class UseCase1_6_2
	{
		...
		[TestMethod]
		public void NoItemFoundRemoveItemStoreRegisterUser()
		{
			_bridge.EnterSystem();
			_bridge.SignIn(usertoSignIn, userPass);
			Assert.AreEqual((int)RemoveFromCartStatus.NoItemFound, _bridge.RemoveFromCart("Blah", "doritos", 30).Status);
		...
		[TestMethod]
		public void NoItemFoundRemoveItemStoreGuest()
		{
			Assert.AreEqual((int)RemoveFromCartStatus.NoItemFound, _bridgeGuest.RemoveFromCart("Blah", "cheaps", 20).Status);
			MarketAnswer res = _bridgeGuest.ViewCart();
			Assert.AreEqual((int)ViewCartStatus.Success, res.Status);
			string[] cartItemsReceived = res.ReportList;
			string[] cartItemsExpected =
		...
		[TestMethod]
		public void NoItemFoundRemoveItemProductRegisterUser()
		{
			_bridge.EnterSystem();
			_bridge.SignIn(usertoSignIn, userPass);
			Assert.AreEqual((int)RemoveFromCartStatus.NoItemFound, _bridge.RemoveFromCart("BlahStore", "bis", 200).Status);
			MarketAnswer res2 = _bridge.ViewCart();
			Assert.AreEqual((int)ViewCartStatus.Success, res2.Status);
			string[] cartItemsReceived = res2.ReportList;
			string[] cartItemsExpected =
		...
		[TestMethod]
		public void NoItemFoundRemoveItemProductGuest()
		{
	
			Assert.AreEqual((int)RemoveFromCartStatus.NoItemFound, _bridgeGuest.RemoveFromCart("BlahStore", "che", 20).Status);
			MarketAnswer res = _bridgeGuest.ViewCart();
			Assert.AreEqual((int)ViewCartStatus.Success, res.Status);
			string[] cartItemsReceived = res.ReportList;
			string[] cartItemsExpected =
		...
		[TestMethod]
		public void NoItemFoundRemoveItemPriceRegisterUser()
		{
			_bridge.EnterSystem();
			_bridge.SignIn(usertoSignIn, userPass);
			Assert.AreEqual((int)RemoveFromCartStatus.NoItemFound, _bridge.RemoveFromCart("BlahStore", "bisli", 20).Status);
			MarketAnswer res2 = _bridge.ViewCart();
			Assert.AreEqual((int)ViewCartStatus.Success, res2.Status);
			string[] cartItemsReceived = res2.ReportList;
			string[] cartItemsExpected =
		...
		[TestMethod]
		public void NoItemFoundRemoveItemPriceGuest()
		{
			
			Assert.AreEqual((int)RemoveFromCartStatus.NoItemFound, _bridgeGuest.RemoveFromCart("BlahStore2", "doritos", 100).Status);
			MarketAnswer res = _bridgeGuest.ViewCart();
			Assert.AreEqual((int)ViewCartStatus.Success, res.Status);
			string[] cartItemsReceived = res.ReportList;
			string[] cartItemsExpected =
