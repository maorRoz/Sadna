    ...
    public class SystemDL
    {
        ...
        private static void CreateTables()
        {
            ...
            string[] thingsToInsertByForce =
            {
                ...
                "INSERT INTO Products (SystemID, Name, BasePrice, Description) VALUES ('P14', 'Pizza', 60, 'food')",
                ...
                "INSERT INTO Stock (StockID, ProductSystemID, Quantity, Discount, PurchaseWay) VALUES ('S5', 'P14', 10, 'D1', 'Immediate')",
