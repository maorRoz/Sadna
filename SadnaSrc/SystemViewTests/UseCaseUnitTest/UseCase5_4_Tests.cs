...
namespace SystemViewTests.UseCaseUnitTest
{
    ...
    public class UseCase5_4_Tests
    {
        ...
        public void PurchaseHistoryOfUserTest()
        {
            ...
            {
                new PurchaseHistory(userNameToView1, "Health Potion", storeNameToView1, "Immediate",2,11.5, "2018-12-29").ToString(),
                new PurchaseHistory(userNameToView1, "INT Potion", storeNameToView2, "Lottery",2,8.0, "2018-12-29").ToString(),
                new PurchaseHistory(userNameToView1, "Mana Potion", storeNameToView2, "Lottery",3,12.0, "2018-12-29").ToString(),
        ...
        public void PurchaseHistoryOfStoreTest()
        {
            ...
            string[] expectedHistory =
            {
                new PurchaseHistory(userNameToView1, "Mana Potion", storeNameToView2, "Lottery",3,12.0, "2018-12-29").ToString(),
                new PurchaseHistory(userNameToView1, "INT Potion", storeNameToView2, "Lottery",2,8.0, "2018-12-29").ToString(),
                new PurchaseHistory(userNameToView2, "STR Potion", storeNameToView2, "Immediate",1,4.0, "2018-12-29").ToString(),
